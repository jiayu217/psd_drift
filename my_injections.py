...
data = read_frame('L-L1_GWOSC_4KHZ_R1-1256747008-4096.gwf', channel_name)
h1 = data
...
realization = 100
time_inj_vec = np.random.randint(low = 1, high = 4095, size = realization)
...
##Save to file
np.savez('project_psd_drifting/data/snr_recovered_data_%d'%iteration, snr_orig=snr_recovered, snr_band_corr=snr_bands_drift, 
